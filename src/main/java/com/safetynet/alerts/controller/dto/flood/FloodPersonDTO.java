...
/**
 * Data Transfer Object (DTO) représentant un habitant
 * dans le cadre d'une alerte de type flood.
 *
 * <p>Ce DTO contient les informations personnelles et médicales
 * d'une personne résidant à une adresse concernée par une situation
 * d'urgence.</p>
 */
